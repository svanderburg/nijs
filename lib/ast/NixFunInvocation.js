...
NixFunInvocation.prototype.toNixExpr = function(indentLevel) {
    ...
    if((this.funExpr instanceof nijs.NixFunction) || (this.funExpr instanceof nijs.NixFunInvocation)) { // Function definitions and function invocations require ( ) around them to make them work
