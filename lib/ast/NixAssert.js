...
/* NixAssert inherits from NixObject */
inherit(NixObject, NixAssert);

/**
 * @see NixObject#toNixExpr
 */
NixAssert.prototype.toNixExpr = function(indentLevel) {
    return "assert " + nijs.jsToIndentedNix(this.conditionExpr, indentLevel) + ";\n" +
        nijs.generateIndentation(indentLevel) + nijs.jsToIndentedNix(this.body, indentLevel)
};
