 ...
 * supposted to be extended by other prototypes so that they can expose their
 * properties as a Nix expression.
 * Alternatively, the constructor can be used as an adapter for any object
 * implementing a toNixAST function member.
 *
 * @constructor
 * @param {Object} An object implementing a toNixAST function member (optional)
 */
