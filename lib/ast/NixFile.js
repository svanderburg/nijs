 ...
 */
NixFile.prototype.toNixExpr = function(indentLevel) {
    var dir = "";
    ...
    /* Compase a resolved path that does not contain any relative path components */
    var actualPath = path.resolve(path.join(dir, this.value))
