 ...
 * @class NixMergeAttrs
 * @extends NixBlock
 * @classdesc Captures the abstract syntax of the Nix attribute set merge
 * operator // which merges the fields of two sets together. If there are
 * duplicate key names the latter takes precedence over the former.
 *
 * @constructor
