...
function callNixBuild(args) {
    ...
    var expression = "let\n"+
      "  pkgs = " + pkgsExpression + ";\n"+
      "  nijs = "+ nijsPath + ";\n"+
      '  nijsFunProxy = import "${nijs}/lib/node_modules/nijs/lib/funProxy.nix" { inherit (pkgs) stdenv lib nodejs; inherit nijs; };\n'+
      '  nijsInlineProxy = import "${nijs}/lib/node_modules/nijs/lib/inlineProxy.nix" { inherit (pkgs) stdenv lib writeTextFile nodejs; inherit nijs; };\n'+
      "in\n" +
      args.nixExpression;
