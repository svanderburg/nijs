...
function inherit(parent, child) {
    function F() {}; /* Dummy constructor function used to create an empty object with the parent's prototype */
    ...
    child.prototype = new F(); /* Create an instance of the dummy custructor. This call returns an empty object, which has the parent's prototype */
