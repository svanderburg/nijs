...
/**
 * Creates a string generating a node.js invocation executing a JavaScript code
 * fragment.
 *
...
exports.callNixBuild = function(args) {
    var expression = "let\n"+
      ...
      "  nijsInlineProxy = import <nijs/lib/inlineProxy.nix> { inherit (pkgs) stdenv writeTextFile nodejs; };\n"+
