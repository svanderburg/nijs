...
function nixBuild(args) {
    ...
    var nijsPathComponent = "nijs=" + path.resolve(path.join(path.dirname(module.filename), "..", "..", "..", ".."));
    var newEnv = process.env;
    
    if(newEnv.NIX_PATH === undefined || newEnv.NIX_PATH == "")
